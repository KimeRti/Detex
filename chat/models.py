...
class Room(models.Model):
    ...
    first_user = models.ForeignKey(User,related_name="room_first",on_delete=models.CASCADE)
    second_user = models.ForeignKey(User,related_name="room_second",on_delete=models.CASCADE)
